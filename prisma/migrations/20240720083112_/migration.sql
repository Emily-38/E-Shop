/*
  ...
  - You are about to drop the column `quantity` on the `cartcontent` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `cartcontent` DROP COLUMN `quantity`;

-- AlterTable
ALTER TABLE `stock` ADD COLUMN `cartContentId` VARCHAR(191) NULL;
